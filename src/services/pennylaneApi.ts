...
export const pennylaneApi = {
  ...
  async getResultatComptable(): Promise<PennylaneResultatComptable[]> {
    try {
      ...
      // Pour l'instant, utiliser des données simulées réalistes
      // TODO: Implémenter les vrais endpoints quand ils seront disponibles
      console.log('📊 Utilisation de données simulées basées sur DIMO DIAGNOSTIC')
