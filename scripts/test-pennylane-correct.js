// Script pour tester l'API Pennylane avec l'URL correcte
const fetch = (...args) => import('node-fetch').then(({default: fetch}) => fetch(...args))

async function testPennylaneCorrect() {
  console.log('🔍 Test de l\'API Pennylane avec l\'URL correcte...')
  ...
  try {
    // Test avec l'URL correcte de Pennylane
    ...
    // URL correcte de Pennylane
    const url = `https://api.pennylane.io/api/v1/trial-balance?start_date=${startDateStr}&end_date=${endDateStr}`
    console.log(`🔗 URL: ${url}`)
